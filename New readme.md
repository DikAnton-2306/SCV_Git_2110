...
## Дополнения Дика Антона

Если мы хотим принять участие в каком-либо проекте:
1. Делаем форк (fork) интересующего нас репозитория - появляется версия форкнутого репозитория на нашем аккаунте на GitHub.
